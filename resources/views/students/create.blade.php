     ...
     <div class="row">
      ...
      <h1 class="mt-3">Form Tambah Data Mahasiswa</h1>
        ...
        <div class="form-group">
            ...
            @enderror" id="nama" placeholder="Masukan Nama" name="nama" value="{{ old('nama') }}">
        ...
        <div class="form-group">
            ...
            @enderror" id="nrp" placeholder="Masukan NRP" name="nrp" value="{{ old('nrp') }}">
        ...
        <div class="form-group">
            ...
            @enderror" id="email" placeholder="Masukan Email" name="email" value="{{ old('email') }}">
        ...
        <div class="form-group">
            ...
            @enderror" id="jurusan" placeholder="Masukan Jurusan" name="jurusan" value="{{ old('jurusan') }}">
